...
VER_NUM=6.0.0 # should logically match with version number above
...
git clone ${IWYU_REPO}/include-what-you-use.git tools/clang/tools/include-what-you-use  # IWYU
